<#
===============================================================================
ITRGA_V2_BE12_LOCKREFUSAL_400PIN_V2.ps1
===============================================================================
Pack:      ITRGA-V2-BE12-LOCKREFUSAL-400PIN-V2  (the ladder's TRUE LAST field act)
...
Write-Host 'Pack: ITRGA-V2-BE12-LOCKREFUSAL-400PIN-V2'
Write-Host 'V2 NOTE: supersedes V1, which died at C2 on ERRATUM E-400PIN-C2 (stderr tripwire; zero mutation; V1 never to be re-run).'
...
Write-Host 'Authority: BO-V2-BE12E-001 closeout condition (i) / ITRGA_VERDICT_V2_BE12_DR5_GATE_001 SS4 / DR-2 / DR-F1 AM-2 / credential law N-O18 / ERRATUM E-400PIN-C2'
