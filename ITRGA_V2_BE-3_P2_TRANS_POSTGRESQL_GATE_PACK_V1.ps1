# =====================================================================
# AXIOM V2 BE-3 P2 STATUS TRANSITION - ITRGA POSTGRESQL GATE EVIDENCE PACK (V1)
# Pack ID: ITRGA-V2-BE-3-P2-TRANS-PG-GATE-PACK-V1
# Authority:
...
#   C:\Users\victo\.vscode\AXIOM\axiom\ITRGA_V2_BE-3_P2_TRANS_POSTGRESQL_GATE_PACK_V1.ps1
#
# Run from the AXIOM repository root, as a file (exactly one command):
#   powershell -NoProfile -ExecutionPolicy Bypass -File ".\ITRGA_V2_BE-3_P2_TRANS_POSTGRESQL_GATE_PACK_V1.ps1"
#
# Output (submit this one file to ITRGA):
#   C:\Users\victo\.vscode\AXIOM\axiom\operator-evidence\BE-3-P2-transition\BE-3-P2-TRANS-GATE-EVIDENCE-V1.txt
# =====================================================================
...
$Transcript   = Join-Path $EvidenceDir "BE-3-P2-TRANS-GATE-EVIDENCE-V1.txt"
...
Write-Evidence "Pack: ITRGA-V2-BE-3-P2-TRANS-PG-GATE-PACK-V1"
