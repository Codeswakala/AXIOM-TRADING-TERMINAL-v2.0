<#
===============================================================================
ITRGA_V2_BE12_LOCKREFUSAL_400PIN_V3.ps1
===============================================================================
Pack:      ITRGA-V2-BE12-LOCKREFUSAL-400PIN-V3  (the ladder's TRUE LAST field act)
...
Run:       Set-Location C:\Users\victo\.vscode\AXIOM\axiom
           powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\ITRGA_V2_BE12_LOCKREFUSAL_400PIN_V3.ps1
...
Write-Host 'Pack: ITRGA-V2-BE12-LOCKREFUSAL-400PIN-V3'
Write-Host 'V3 NOTE: supersedes V2 (E-400PIN-C3: doc door now proof-enumerated); V1/V2 never to be re-run.'
...
Write-Host 'Authority: BO-V2-BE12E-001 closeout condition (i) / ITRGA_VERDICT_V2_BE12_DR5_GATE_001 SS4 / DR-2 / DR-F1 AM-2 / credential law N-O18 / ERRATA E-400PIN-C2 + E-400PIN-C3'
