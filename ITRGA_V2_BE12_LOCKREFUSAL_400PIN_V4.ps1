<#
===============================================================================
ITRGA_V2_BE12_LOCKREFUSAL_400PIN_V4.ps1
===============================================================================
Pack:      ITRGA-V2-BE12-LOCKREFUSAL-400PIN-V4  (the ladder's TRUE LAST field act)
...
Run:       Set-Location C:\Users\victo\.vscode\AXIOM\axiom
           powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\ITRGA_V2_BE12_LOCKREFUSAL_400PIN_V4.ps1
...
Write-Host 'Pack: ITRGA-V2-BE12-LOCKREFUSAL-400PIN-V4'
Write-Host 'V4 NOTE: doors selected by pinned presence in preferred namespace; census pins BOTH counting laws (21 paths == 22 operations x 2 mounts = 42). V1/V2/V3 never to be re-run.'
...
Write-Host 'Authority: BO-V2-BE12E-001 closeout condition (i) / ITRGA_VERDICT_V2_BE12_DR5_GATE_001 SS4 / DR-2 / DR-F1 AM-2 / credential law N-O18 / ERRATA E-400PIN-C2 + E-400PIN-C3(+addendum)'
