"""W4-U05 portfolio risk research reports
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("stress_loss", sa.Float(), nullable=False),
    ...
    op.create_index(
        "ix_portfolio_risk_reports_created_at",
        "portfolio_risk_reports",
        ["created_at"],
    )
    op.create_index(
        "ix_portfolio_risk_reports_series",
        "portfolio_risk_reports",
        ["market_class", "symbol", "timeframe"],
    )
    op.create_index(
        "ix_portfolio_risk_reports_report_hash",
        "portfolio_risk_reports",
        ["report_hash"],
    )
    op.create_index(
        "ix_portfolio_risk_reports_correlation_id",
        "portfolio_risk_reports",
...
def downgrade() -> None:
    op.drop_index("ix_portfolio_risk_reports_correlation_id", table_name="portfolio_risk_reports")
    op.drop_index("ix_portfolio_risk_reports_report_hash", table_name="portfolio_risk_reports")
    op.drop_index("ix_portfolio_risk_reports_series", table_name="portfolio_risk_reports")
    op.drop_index("ix_portfolio_risk_reports_created_at", table_name="portfolio_risk_reports")
