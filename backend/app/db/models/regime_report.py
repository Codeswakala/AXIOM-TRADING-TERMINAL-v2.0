"""Regime detection report model (W4-U03)."""
...
class RegimeReport(Base):
    """Persisted inert regime research artifact."""

    __tablename__ = "regime_reports"
    __table_args__ = (
        Index("ix_regime_reports_created_at", "created_at"),
        Index("ix_regime_reports_series", "market_class", "symbol", "timeframe"),
        Index("ix_regime_reports_label", "regime_label"),
        Index("ix_regime_reports_report_hash", "report_hash"),
        Index("ix_regime_reports_correlation_id", "audit_correlation_id"),
    )
    ...
    economic_meaning: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False)
