"""Correlation report API schemas (W4-U02)."""
...
class CorrelationReportRead(BaseModel):
    id: str
    created_at: datetime
    artifact_type: str
    method_version: str
    left_market_class: str
    left_symbol: str
    right_market_class: str
    right_symbol: str
    timeframe: str
    ...
    def _datetimes_utc(cls, value: datetime) -> datetime:
        normalized = coerce_external_utc(value, source="correlation report schema output")
