"""Regime report API schemas (W4-U03)."""
...
class RegimeReportRead(BaseModel):
    id: str
    created_at: datetime
    artifact_type: str
    method_version: str
    ...
    def _datetimes_utc(cls, value: datetime) -> datetime:
        normalized = coerce_external_utc(value, source="regime report schema output")
