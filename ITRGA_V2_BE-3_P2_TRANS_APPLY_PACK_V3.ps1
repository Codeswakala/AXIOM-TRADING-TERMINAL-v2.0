# =====================================================================
# *** SUPERSEDED FOR FUTURE EXECUTIONS - 2026-08-29 (PGF-009) ***
# This pack executed attempt V3 of the SQLite apply act, which aborted
# at 0B (line 199) with zero side effects: a compound braced expansion
# (${Expr.With.Calls}) that PowerShell 5.1 treats as a literal variable
# name (ITRGA-ASS-V2-BE-3-P2-TRANS-APPLY-RUN-V3). Superseded by
# ITRGA_V2_BE-3_P2_TRANS_APPLY_PACK_V4.ps1 (all 8 compound braced
# expansions removed; all other logic byte-identical). This file
# remains on record as the instrument of attempt V3. The original text
# below is preserved unedited.
# =====================================================================
# =====================================================================
# AXIOM V2 BE-3 P2 STATUS TRANSITION - ITRGA SQLITE APPLY ACT EVIDENCE PACK (V3)
# Pack ID: ITRGA-V2-BE-3-P2-TRANS-APPLY-PACK-V3
# Authority:
...
# Pattern: ITRGA-V2-BE-3-P2-TRANS-APPLY-PACK-V2 (defect-corrected
#   structure; PGF-001..008 lessons incorporated by construction).
#   V3 delta vs V2 (minimal): input quote normalization at 0B (PGF-008)
#   + header/transcript naming. All other logic byte-identical to V2.
#
# WHAT THIS PACK DOES:
...
#   C:\Users\victo\.vscode\AXIOM\axiom\ITRGA_V2_BE-3_P2_TRANS_APPLY_PACK_V3.ps1
#
# Run from the AXIOM repository root, as a file (exactly one command):
#   powershell -NoProfile -ExecutionPolicy Bypass -File ".\ITRGA_V2_BE-3_P2_TRANS_APPLY_PACK_V3.ps1"
#
# Output (submit this one file to ITRGA):
#   C:\Users\victo\.vscode\AXIOM\axiom\operator-evidence\BE-3-P2-transition\BE-3-P2-TRANS-APPLY-EVIDENCE-V3.txt
# =====================================================================
...
$Transcript   = Join-Path $EvidenceDir "BE-3-P2-TRANS-APPLY-EVIDENCE-V3.txt"
...
Write-Evidence "Pack: ITRGA-V2-BE-3-P2-TRANS-APPLY-PACK-V3"
Write-Evidence "Pack note: V3 - input quote normalization (PGF-008); all other logic identical to V2"
