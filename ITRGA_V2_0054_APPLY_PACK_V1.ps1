<#
===============================================================================
ITRGA_V2_0054_APPLY_PACK_V1.ps1
===============================================================================
Pack:      ITRGA-V2-0054-APPLY-PACK-V1
...
$TranscriptPath = Join-Path $EvDir ("0054-APPLY-RUN-V1-{0}.txt" -f $ts)
...
function Assert-Gate { param([bool]$Cond, [string]$Label, [string]$Expect, [string]$Actual)
  ...
  Write-Host 'Send this transcript to ITRGA. Restoration (if ITRGA instructs) is via the anchor only.'
...
Write-Host 'Pack: ITRGA-V2-0054-APPLY-PACK-V1'
