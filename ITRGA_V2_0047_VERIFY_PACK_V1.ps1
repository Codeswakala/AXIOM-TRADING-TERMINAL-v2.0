...
# Pack ID: ITRGA-V2-0047-VERIFY-PACK-V1
...
#   root, ONLY after ITRGA_V2_0047_APPLY_PACK_V1.ps1 has PASSed:
...
#   3. Send back operator-evidence\BE-7\0047-VERIFY-RUN-V1.txt.
# =====================================================================
...
$Transcript    = Join-Path $EvidenceDir "0047-VERIFY-RUN-V1.txt"
...
if (!(Test-Path $ApplyRecPath)) {
    throw ("STOP: apply-final-state record missing: " + $ApplyRecPath + " . The verify act cannot precede the apply act. Run ITRGA_V2_0047_APPLY_PACK_V1.ps1 first.")
}
...
Write-Section "0047 VERIFY PACK V1 - ITRGA-V2-0047-VERIFY-PACK-V1"
...
if ($ApplyState["STATE_FILE_ID"] -ne "ITRGA-V2-0047-APPLY-FINAL-STATE-V1") { throw "STOP: apply state identity mismatch." }
...
$VLines = @(
    "STATE_FILE_ID=ITRGA-V2-0047-VERIFY-FINAL-STATE-V1",
    ...
    "TRANSCRIPT=0047-VERIFY-RUN-V1.txt",
...
Write-Evidence ""
Write-Evidence "VERIFY PACK COMPLETE - PASS. The 0047 working-DB application act is proven end-to-end on the operator environment. The application may be restarted. Send back operator-evidence\BE-7\0047-APPLY-RUN-V1.txt and 0047-VERIFY-RUN-V1.txt to ITRGA."
