...
# Pack ID: ITRGA-V2-0047-APPLY-PACK-V3
# Authority:
...
#     powershell -NoProfile -ExecutionPolicy Bypass -File ".\ITRGA_V2_0047_APPLY_PACK_V3.ps1"
...
#        ITRGA_V2_0047_APPLY_PACK_V3.ps1   (this file; runs FIRST)
#        ITRGA_V2_0047_VERIFY_PACK_V3.ps1  (runs SECOND, after this PASS)
...
#        operator-evidence\BE-7\0047-APPLY-RUN-V3.txt
...
$Transcript    = Join-Path $EvidenceDir "0047-APPLY-RUN-V3.txt"
$StateRecPath  = Join-Path $EvidenceDir "0047-APPLY-FINAL-STATE.txt"
$AnchorPath    = Join-Path $EvidenceDir "0047-ANCHOR-axiom_dev.v3.bak"
...
Write-Section "0047 APPLY PACK V3 - ITRGA-V2-0047-APPLY-PACK-V3"
...
$StateLines = @(
    "STATE_FILE_ID=ITRGA-V2-0047-APPLY-FINAL-STATE-V3",
    ...
    "TRANSCRIPT=0047-APPLY-RUN-V3.txt",
...
Write-Evidence ""
Write-Evidence "APPLY PACK COMPLETE - PASS. Chain at 20260903_0047 (head). Keep the application STOPPED. Next act: execute ITRGA_V2_0047_VERIFY_PACK_V3.ps1, then send back operator-evidence\BE-7\0047-APPLY-RUN-V3.txt and 0047-VERIFY-RUN-V2.txt. Restart the application only after the verify pack PASSes."
